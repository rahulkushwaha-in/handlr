...
export default function ProfileScreen() {
  ...
  const preferencesMenuItems = [
    ...
    { 
      ...
      toggle: true, 
      value: isDark, 
      onToggle: () => setThemePreference(isDark ? 'light' : 'dark') 
    },
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.themeModal}>
            ...
            >
              ...
              {currentActiveTheme === 'light' && <View style={[styles.themeOptionCheck, { backgroundColor: colors.primary }]} />}
            </TouchableOpacity>
            ...
            <Button title="Close" onPress={() => setShowThemeModal(false)} variant="outline" />
          </View>
        </View>
      </Modal>
    </View>
...
const dynamicStyles = (colors, currentTheme) => StyleSheet.create({
  container: {
    flex: 1,
